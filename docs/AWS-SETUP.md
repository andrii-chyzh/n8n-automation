...
2. Виберіть файл `../workflows/FIN invoice checking and sorting.json`
...
### Проблема: "Code node not found"
- Переконайтеся, що використовується n8n версії 1.103.2+
- Перевірте, що Code node доступний в списку нод
...
✅ **Мінімалізм** - використовує стандартний n8n образ  
✅ **Швидкість** - швидка збірка Docker образу  
✅ **Надійність** - використовує Pyodide (WebAssembly)  
...
3. Додайте діагностичні print statements в код
